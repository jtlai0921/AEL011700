...
Public Class Form1
    ...
    Private Sub mnuItemIE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuItemIE.Click
        Dim progID As Integer
        progID = Shell("C:\Program Files\Internet " &
           "Explorer\IEXPLORE.EXE", AppWinStyle.MaximizedFocus)
    End Sub

    Private Sub mnuItemPaint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuItemPaint.Click
        Dim progID As Integer
        progID = Shell("C:\Windows\System32\mspaint.exe",
                        AppWinStyle.NormalFocus)
    End Sub

    Private Sub mnuItemNotePad_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuItemNotePad.Click
        Dim progID As Integer

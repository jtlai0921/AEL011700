Public Class Form1
    ...
    Private Sub mnuItemImage_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuItemImage.Click
        Dim path As String = "\VB2010\Ch14\" ' 檔案路徑
        Dim g1 As Graphics = Graphics.FromImage(buffer)
    ...
    Private Sub mnuItemSmall_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuItemSmall.Click
        Dim path As String = "\VB2010\Ch14\" ' 檔案路徑
        Dim g1 As Graphics = Graphics.FromImage(buffer)
        Dim bmp = New Bitmap(path & "sample.bmp")
    ...
    Private Sub mnuItemClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuItemClear.Click
        Dim g1 As Graphics = Graphics.FromImage(buffer)
